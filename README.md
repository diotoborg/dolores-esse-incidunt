...
[![NPM Version](https://img.shields.io/npm/v/@diotoborg/dolores-esse-incidunt.svg?&style=flat-square)](https://www.npmjs.org/package/@diotoborg/dolores-esse-incidunt)
[![Build Status](https://api.travis-ci.org/Alex-Werner/@diotoborg/dolores-esse-incidunt.svg?branch=master)](https://travis-ci.com/Alex-Werner/@diotoborg/dolores-esse-incidunt)
...
```js
const {FSLock, File, Directory} = require('@diotoborg/dolores-esse-incidunt');
